...
public class Conflagracao extends HabilidadeBase{
    ...
    public void noUso(ArenaBatalha arena) {
        ...
        int duracao_efeito;
        Efeitos efeito_de_reducao_de_ataque = new EfeitoAtributos(10.00,0.00,EfeitosBasicos.DANO_POR_TURNO,3);
    ...
    public File pegarArquivoImagem() {
        return( new File(getClass().getResource("/View/Imagens/Habilidades/conflagracao.jpg").getFile() ) );
    }
