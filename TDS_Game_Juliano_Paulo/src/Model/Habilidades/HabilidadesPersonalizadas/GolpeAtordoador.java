...
public class GolpeAtordoador extends HabilidadeBase{
    ...
    protected void setDescricao() {
       descricao = "Ataque um alvo dando dano igual a 300% do ataque e causa atordoamento por 1 turno!\nTempo de recarga 4 turnos";
    }
    ...
    public File pegarArquivoImagem() {
        return( new File(getClass().getResource("/View/Imagens/Habilidades/golpeatordoador.jpg").getFile() ) );
    }
