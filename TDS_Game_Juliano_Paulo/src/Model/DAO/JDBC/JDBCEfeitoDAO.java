...
public class JDBCEfeitoDAO extends JDBCAbstractDAO implements EfeitoDAO {
    ...
    public boolean atualizar(Efeitos t) throws DatabaseException {
        QUERY.append("UPDATE Efeito SET tipo=?, SET comportamento=?, ")
             .append("SET instantaneo=?, SET duracao=?, ")
             .append("SET poder_percentual=?, SET poder_constante=?, ")
             .append("SET descricao=? ")
             .append("WHERE itemId=").append(t.getEfeitoID());
