...
public class Cobra extends Monstro{
    public Cobra(int level)
    {
        ...
        this.setAtaque(120 + (level-1)*60 + numeroRandom + 0.00);
        
        numeroRandom = gerador.nextInt(20);
        this.setDefesa(100 + (level-1)*50 + numeroRandom + 0.00);
        
        numeroRandom = gerador.nextInt(20);
        this.setVelocidade(80 + (level-1)*20 + numeroRandom + 0.00);
        
        numeroRandom = gerador.nextInt(200);
        this.setMaxPontosVida(600 + (level-1)*400 + numeroRandom + 0.00);
