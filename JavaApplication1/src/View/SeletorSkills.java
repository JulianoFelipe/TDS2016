 ...
 * @author FREE
 */
public class SeletorSkills extends JFrame{
    SeletorSkills(List< BaseSkill > lista_de_skills)
    {
        ...
        for (int i=0;i<4;i++)
        {
            ...
            CartaSkill carta_skill;
            if (i >= lista_de_skills.size())
            {
                carta_skill = new CartaSkill(null,this);
                btSelecionar.setEnabled(false);
            }
            else
            {
                carta_skill = new CartaSkill(lista_de_skills.get(i),this);
            }
    ...
    public static void main(String args[])
    {
        ...
        SeletorSkills teste = new SeletorSkills(lista);
