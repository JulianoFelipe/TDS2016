...
public abstract class BaseCreature implements Comparable,Describable{
    ...
    /**
     * Ataque bar da criatura, quando attack_bar == attack_max to move criatura ganhara turno
     */
    ...
    /**
     * Diminui ataque
     * @param increment o quanto diminui 
     */
    ...
    /**
     * Os efeitos que chegarem ao fim sao removidos os outros suas duracao sao decrementadas
     */
